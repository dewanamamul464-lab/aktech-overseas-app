...
// =========================================================
//
// Search is performed by Spring Boot.
//
// Example:
//
// search = "engineer"
...
totalElements =
(decoded['totalElements'] as num).toInt();
}
...
// GET /api/jobs/15
//
// This retrieves the complete Job object using the
// jobId received from AiJobMatch.
// =========================================================
...
// =====================================================
  ...
  final Job job = Job.fromJson(decoded);
...
//
// This should NOT normally be used by JobsScreen.
// =========================================================
